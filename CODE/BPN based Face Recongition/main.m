...
clc
close all
tic; %%Read elapsed time
% To open the browse option in the front end we fix the initial directory paths
TrainDatabasePath = uigetdir('C:\Users\Meehan\Downloads\Attempt_2_Thesis\CODE\BPN based Face Recongition', 'Select the path of training images' );
...
TestDatabasePath = uigetdir('C:\Users\Meehan\Downloads\Attempt_2_Thesis\CODE\BPN based Face Recongition', 'Select the path of testing images');
...
recognition_rate=abs(47*(size(N,2)-wrong)/size(N,2))
